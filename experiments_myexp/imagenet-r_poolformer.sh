...
#OUTDIR=/vast/palmer/scratch/panda/yk569/OneStagePCL/outputs_poolformerm38query_vit_l2_5e-3/${DATASET}/10-task
#OUTDIR=/vast/palmer/scratch/panda/yk569/OneStagePCL/ori_clsdetach_l2_1_T10/${DATASET}/10-task




OUTDIR=/vast/palmer/scratch/panda/yk569/OneStagePCL/ori_cls_poolformerquery_vit_qrloss_l2sftmax_1e-4/${DATASET}/5-task
...
#OUTDIR=/vast/palmer/scratch/panda/yk569/OneStagePCL/ori_cls_poolformerquery_vit_qrloss_l2sftmax_1e-4/${DATASET}/20-task
...
#OUTDIR=/vast/palmer/scratch/panda/yk569/OneStagePCL/ori_cls_poolformerm38query_vit_qrloss_l2sftmax_1e-4/${DATASET}/10-task
